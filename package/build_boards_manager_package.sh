...
[ -z "${REMOTE_URL}" ] && REMOTE_URL=https://github.com/TeamOpenFIRE/arduino-pico/releases/download
...
curl --silent https://api.github.com/repos/TeamOpenFIRE/arduino-pico/releases > releases.json
...
curl -L -o $old_json "https://github.com/TeamOpenFIRE/arduino-pico/releases/download/${base_ver}/package_rp2040_index.json"
